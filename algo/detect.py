...
def detect(weights='yolov5s.pt',  # model.pt path(s)
           ...
           project='map-defects',  # save results to project/name                   Needs to be empty
           # save results to project/name                              Needs to be set map-defects
           name='',
           # existing project/name ok, do not increment                             Needs to be set at True
           exist_ok=True,
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if save_crop:
                            save_one_box(
                                xyxy, imc, file=save_dir / f'crops_{names[c]}_{p.stem}.jpg', BGR=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', default='/home/lucien/Work/TORAY/IA/monitoring_yolo/map-defects',  # path to map-defect folder
